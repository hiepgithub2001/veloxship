...
const vi = {
  ...
  layout: {
    ...
    vehicles: 'Đội xe',
    search: 'Tra cứu',
    globalSearchPlaceholder: 'Tìm mã phiếu, tên hoặc SĐT khách hàng...',
    globalSearchEmpty: 'Không tìm thấy phiếu gửi phù hợp.',
    globalSearchHint: 'Nhập mã phiếu, tên hoặc số điện thoại khách hàng',
  },
  common: {
    save: 'Lưu',
    cancel: 'Huỷ',
  ...
  bills: {
    ...
    fetchError: 'Không thể tải danh sách phiếu gửi',
    statusFilter: 'Trạng thái',
    dateRange: 'Khoảng thời gian tạo',
  ...
  customers: {
    ...
    total: 'Tổng {total} khách hàng',
    createdFromBillsHint: 'Hồ sơ được tạo tự động khi lập phiếu gửi.',
