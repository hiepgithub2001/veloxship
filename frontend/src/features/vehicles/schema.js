...
export const vehicleFormSchema = z.object({
  ...
  vehicle_type: z.enum(['motorcycle', 'truck'], {
    errorMap: () => ({ message: "Loại xe phải là 'motorcycle' hoặc 'truck'." }),
  }),
  max_weight_kg: z.coerce
    .number({ invalid_type_error: 'Tải trọng phải là số.' })
    .positive('Tải trọng phải là số dương.'),
  max_volume_m3: z.coerce
    .number({ invalid_type_error: 'Thể tích phải là số.' })
